...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <rsweb:ReportViewer ID="GenreAlbumReportViewer" runat="server"
        ...
        <LocalReport ReportPath="Reports\GenreAlbumReport.rdlc">
            <DataSources>
                <rsweb:ReportDataSource Name="GenreAlbumsReport"
                    DataSourceId="GenreAlbuReportODS"></rsweb:ReportDataSource>
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>

    <asp:ObjectDataSource ID="GenreAlbuReportODS" runat="server"
